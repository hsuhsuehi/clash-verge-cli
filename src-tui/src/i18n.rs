...
fn english(key: &'static str) -> &'static str {
    match key {
        ...
        "profiles.hint" => "Enter switch | u update | i add | e rename | d delete",
        ...
        "settings.gui_config" => "GUI config (read-only)",
        ...
        "dialog.delete_profile_title" => "Delete profile?",
        "dialog.delete_profile_body" => "Profile: {name}",
        "dialog.delete_confirm_hint" => "d confirm | Esc cancel",
        _ => key,
    }
}
...
fn chinese(key: &'static str) -> Option<&'static str> {
    Some(match key {
        ...
        "hint.profiles" => "i 导入 | u 更新 | e 重命名 | d 删除 | Enter 切换",
        "hint.connections" => "Enter/d 关闭 | / 过滤",
        "hint.rules" => "j/k 浏览",
        "hint.logs" => "/ 过滤 | j/k 浏览",
        "hint.unlock" => "功能受限",
        "hint.settings" => "Enter 切换语言",
        "status.running" => "运行中",
        "status.starting" => "启动中",
        "status.stopped" => "已停止",
        "status.error" => "错误",
        ...
        "profiles.hint" => "Enter 切换 | u 更新 | i 添加 | e 重命名 | d 删除",
        ...
        "dialog.target" => "目标",
        "dialog.delete_profile_title" => "删除订阅？",
        "dialog.delete_profile_body" => "订阅：{name}",
        "dialog.delete_confirm_hint" => "d 确认 | Esc 取消",
        _ => return None,
    })
}
